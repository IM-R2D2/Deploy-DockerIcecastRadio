...
# Set ownership: project dir to current user; icecast log dir to 1000:1000 (for container)
set_ownership() {
  echo "Setting owner ${CURRENT_USER}:${CURRENT_GROUP} for project directory..."
...
echo ""
echo "If Docker was just installed by this script, run first:  newgrp docker"
echo "  (or log out and back in — otherwise you may get 'permission denied' when running compose)."
